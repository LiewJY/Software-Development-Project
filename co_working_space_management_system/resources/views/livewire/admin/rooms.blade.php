<div>
    ...
    <div class="overflow-x-auto mx-1">
                    ...
                    <tr>
                        ...
                        <td class="border border-black  py-1.5">
                            <div class="border-none flex flex-row flex-nowrap justify-center">
                                ...
                                <x-jet-button class="mx-2" wire:click="deleteModal({{$room ->id}}, '{{$room ->name}}')">Delete</x-jet-button>
                            </div>
                        </td>
        ...
        <form>
            <x-slot name="content">
                <x-jet-label for="locationID" value="Locaiton name"/> 
                <select id="locationID" wire:model.defer="locationID" name="locationID" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                ...
                <x-jet-input id="size" type="text" class="mt-1 block w-full" wire:model.defer="size"/>
