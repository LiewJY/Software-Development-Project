<x-app-layout>
    <section class="bg-gradient-to-br from-white to-gray-500">
        <br>
        ...
        <div class="container mx-auto text-center bg-gray-100 shadow">
            <br>
            <h1 class="font-serif sm:text-3xl text-2xl font-small title-font mb-4 text-black">Trusted By World's Biggest Companies</h1>

            <section class="text-black body-font">
                <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0 shadow-md">
                        <img class="object-cover object-center rounded" alt="STARBUCKS" src="https://awards.brandingforum.org/wp-content/uploads/2016/11/Starbucks-logo.jpg">
                    </div>
            ...
            <section class="text-black body-font">
                <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0 shadow-md">
                        <img class="object-cover object-center rounded" alt="huawei" src="https://1000logos.net/wp-content/uploads/2018/08/Huawei-emblem.jpg">
                    </div>
                    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <section class="text-black body-font">
                <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0 shadow-md">
                        <img class="object-cover object-center rounded" alt="google" src="https://cdn.vox-cdn.com/thumbor/Ous3VQj1sn4tvb3H13rIu8eGoZs=/0x0:2012x1341/1400x788/filters:focal(0x0:2012x1341):format(jpeg)/cdn.vox-cdn.com/uploads/chorus_image/image/47070706/google2.0.0.jpg">
                    </div>
                    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
