<x-app-layout>
  <section class="text-gray-700 body-font relative bg-gray-200">
    ...
    <div class="container px-5 py-10 mx-auto">
      ...
      <div class="container px-5 py-5 mx-auto flex sm:flex-no-wrap flex-wrap">
        <div class="lg:w-2/3 md:w-2/3 bg-gray-300 rounded-lg overflow-hidden sm:mr-20 p-20 flex items-end justify-start relative border border-gray-400">
          <iframe width="100%" height="100%" class="absolute inset-0" frameborder="0" title="map" marginheight="0" marginwidth="0" scrolling="no" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31873.174810067398!2d101.68298123955077!3d3.055345399999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc4abb795025d9%3A0x1c37182a714ba968!2sAsia%20Pacific%20University%20of%20Technology%20%26%20Innovation%20(APU)!5e0!3m2!1sen!2smy!4v1594444871313!5m2!1sen!2smy" style="filter: contrast(1.2) opacity(0.7);">
          </iframe>
        </div>
          ...
          <div class="relative mb-4">
            ...
            <table class="table-fixed border-collapse border border-gray-800 border-t-8 border-b-8 border-double">
              <tr>
                ...
                <th class="w-1/2 border border-gray-900 border-b-8 border-double border-r-4 border-r-4 font-bold">Time</th>
              </tr>
              <tr>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">Monday</td>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">9am - 9pm</td>
              </tr>
              <tr>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">Tuesday</td>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">9am - 9pm</td>
              </tr>
              <tr>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">Wednesday</td>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">9am - 9pm</td>
              </tr>
              <tr>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">Thursday</td>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">9am - 9pm</td>
              </tr>
              <tr>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">Friday</td>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">9am - 9pm</td>
              </tr>
              <tr>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">Saturday</td>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">9am - 9pm</td>
              </tr>
              <tr>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">Sunday</td>
                <td class="border border-gray-900 border-b-8 border-double border-l-4 border-r-4 font-semibold text-center">Closed</td>
              </tr>
            </table>
          </div>
        </div>
  ...
  <section class="text-gray-700 body-font relative bg-gray-300">
    <!-- Gallery -->
    ...
    <div class="container mx-auto flex flex-col px-5 py-0 justify-center items-center">
      <div class="flex flex-wrap md:-m-2 -m-1">
        ...
        <div class="flex flex-wrap w-1/2">
          <div class="md:p-2 p-1 w-full">
            <img alt="gallery" class="w-full h-full object-cover object-center block rounded-lg border" src="https://colony.work/wp-content/uploads/2019/12/Colony-@-KLCC-event-lounge-2.jpeg">
          </div>
          <div class="md:p-2 p-1 w-1/2">
            <img alt="gallery" class="w-full object-cover h-full object-center block rounded-lg border" src="https://i.pinimg.com/564x/db/06/46/db0646659f9f90845ba3f2ed18323f90.jpg">
          </div>
          <div class="md:p-2 p-1 w-1/2">
            <img alt="gallery" class="w-full object-cover h-full object-center block rounded-lg border" src="https://www.kairos.com.my/wp-content/uploads/2019/05/best-coworking-spaces-in-KL-and-Selangor-26-1024x683.jpg">
          </div>
        </div>
      </div>
